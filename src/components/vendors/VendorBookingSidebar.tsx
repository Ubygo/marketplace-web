        ...
        <div className="flex flex-col gap-4 p-5">
          ...
          <div>
            ...
            {selectedService.description ? (
              <p className="mt-2 line-clamp-4 text-sm leading-relaxed text-black/70">
                {selectedService.description}
              </p>
            ) : null}
          </div>
          ...
          {isAuthenticated ? (
            <button
              ...
              className="block w-full rounded-full py-3 text-center text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
